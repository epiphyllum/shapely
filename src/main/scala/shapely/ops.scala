...
// Breaks ambiguity between base and remove case by making base lower priority
...
object Mapper {
  ...
  implicit def corecurse[A, B, L <: HList, P <: Poly](implicit
      C: P#Case[A, B],
      M: Mapper[L, P]): Mapper.Aux[A :: L, P, B :: M.Out] = new Mapper[A :: L, P] {
    type Out = B :: M.Out
